...
<div class="container mb-5" style="margin-top: 100px">
    <div class="row mb-5">
        <div class="col-lg-12">
            <h1 class="text-center heading-wisata">Informasi Penginapan</h1>
        </div>
    </div>
    <div class="row">
        @foreach ($penginapan as $wst)
        <div class="col-lg-4 col-md-6">
            <div class="card mb-4 d-block mx-auto" style="width: 18rem;">
                ...
                <div class="card-body">
                <h6 class="card-title">{{ $wst->judul_info }}</h6>
                <p class="card-text">{!! substr($wst->isi_info, 0, 100) !!} ...</p>
                <a href="/single_berita/{{ $wst->id_informasi }}" class="float-right teks-info">Lihat selengkapnya</a>
